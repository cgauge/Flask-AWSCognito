...
def test_verify(user_pool_id, user_pool_client_id, jwks_endpoint_request):
    serv = TokenService(user_pool_id, user_pool_client_id, jwks_endpoint_request)
    token = 'eyJraWQiOiJwdjVrMkZkcSs1dVZnY2I0anJnQTc2SDdpVkd2QU80dU9taHBDaGVxVERvPSIsImFsZyI6IlJTMjU2In0.' \
    ...
    assert serv.claims == {'sub': 'f8cdd780-080d-44b4-95d0-3ddfd84a2d58',
                           'token_use': 'access',
                           'scope': 'openid email',
